...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250613143349_IssuesResolvedAndSoftDelete")]
    partial class IssuesResolvedAndSoftDelete
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.RevitElement", b =>
                {
                    ...
                    b.Property<string>("ViewpointForwardDirection")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ViewpointUpDirection")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Snapshot", "Snapshot")
                        .WithMany("Comments")
