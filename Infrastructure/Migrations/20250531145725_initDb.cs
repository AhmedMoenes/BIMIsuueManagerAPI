    ...
    public partial class initDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyProjects", x => new { x.CompanyId, x.ProjectId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RevitElementId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ElementId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ElementUniqueId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ViewpointCameraPosition = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SnapshotImagePath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IssueId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RevitElements", x => x.RevitElementId);
                    table.ForeignKey(
                        name: "FK_RevitElements_Issues_IssueId",
                        column: x => x.IssueId,
                        principalTable: "Issues",
                        principalColumn: "IssueId",
                        onDelete: ReferentialAction.Cascade);
